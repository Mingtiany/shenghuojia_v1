...
class Search_Miyou extends Component {
  ...
  search=()=>{
    ...
    this.props.setSearch(Name,City,Area,Sex,RejectPets,
 ...
 if(e.keyPath[0]==="区"){
  ...
  render () {
    return (
        ...
        <Issue_Miyou show={this.state.show} hide={this.hide_issue} display_Miju={this.display_Miju_issue} flag={"0"} hostname={this.state.hostname}/>
        <Issue_Miju show={this.state.showMiju} hide={this.hide_Miju_issue} flag={"1"} hostname={this.state.hostname}/>
